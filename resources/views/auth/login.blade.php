...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('assets/images/logo_prime.png') }}" type="image/x-icon">
    <title>Login</title>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-center gap-1 mb-4">
                            <img src="{{ asset('assets/images/logo_prime.png') }}" style="width: 40px" alt="Logo">
                            <p class="mb-0 text-dark fw-bold fs-5">TaskPrime</p>
                        </div>
